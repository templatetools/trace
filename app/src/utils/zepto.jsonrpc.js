/**
 * @see https://github.com/datagraph/jquery-jsonrpc/blob/master/jquery.jsonrpc.js
 * a zepto,jsonrpc  base on jquery.jsonrpc
 * 修改IIFE 传入的参数为Zepto
 * 修改zepto使用插件扩展方式 @see http://zeptojs.com/#$.fn
 * @date : 2016/9/12.
